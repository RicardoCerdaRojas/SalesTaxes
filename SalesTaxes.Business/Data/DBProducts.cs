...
public class DBProducts : IDBProducts
{
    public List<Product> GetProducts()
    {
        var products = new List<Product>()
        {
            ...
            new Product(4, "Imported box of chocolates 1", 10.00m, true, ProductType.Food),
            new Product(5, "Imported bottle of perfume 1", 47.50m, true, ProductType.Perfum),
            new Product(6, "Imported bottle of perfume 2", 27.99m, true, ProductType.Perfum),
            new Product(7, "bottle of perfume 3", 18.99m, false, ProductType.Perfum),
            new Product(8, "Packet of headache pills", 9.75m, false, ProductType.Medicine),
            new Product(9, "Imported box of chocolates 2", 11.25m, true, ProductType.Food)
        };
        return products;
    }
